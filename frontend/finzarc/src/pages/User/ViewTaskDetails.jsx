...
function ViewTaskDetails() {
  ...
  const handleLinkClick = (link) => {
    if (!/^https?:\/\//i.test(link)) {
      link = "https://" + link; // Default to HTTPS protocol
    }
...
const TodoCheckList = ({ text, isChecked, onChange }) => {
  return (
    <div className="flex items-center gap-3 p-3 outline-none cursor-pointer">
      {/* Checkbox and todo item content would go here */}
    </div>
  );
};
